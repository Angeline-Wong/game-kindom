export type CharacterKind = 'emperor' | 'official' | 'consort' | 'eunuch';
...
export const demoConsort: Character = { id: 'consort', kind: 'consort', name: '顾清漪', title: '宸贵妃 · 翊坤宫主位', age: 22, avatar: '顾', note: '仪态从容，近来常遣宫女前往太医院。', radar: [{label:'才情',value:88},{label:'礼仪',value:84},{label:'容貌',value:91},{label:'健康',value:69},{label:'野心',value:null}] };
