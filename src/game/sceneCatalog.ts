...
export const sceneInteractions: Record<string, SceneInteraction> = {
  taihe: { id: 'taihe', title: '太和殿', category: 'FRONT', actions: ['重大朝会', '册立大典', '凯旋朝贺'], peopleKinds: ['MINISTER', 'PRINCE'], status: 'PARTIAL' },
  'qianqing-gate': { id: 'qianqing-gate', title: '乾清门', category: 'FRONT', actions: ['日常朝会', '议题裁决', '朝仪监察'], peopleKinds: ['MINISTER', 'PRINCE'], status: 'PARTIAL' },
  ...
  wenhua: { id: 'wenhua', title: '文华殿', category: 'FRONT', actions: ['经筵讲学', '皇嗣教育', '策问'], peopleKinds: ['MINISTER', 'PRINCE'], status: 'PARTIAL' },
  ...
  study: { id: 'study', title: '御书房', category: 'FRONT', actions: ['读书', '研究国策', '召见学士'], peopleKinds: ['MINISTER', 'PRINCE'], status: 'PARTIAL' },
  ...
  xiefang: { id: 'xiefang', title: '撷芳殿', category: 'INNER', actions: ['皇嗣照料', '健康', '启蒙', '指定养母'], peopleKinds: ['PRINCE'], status: 'PLANNED' },
  yuqing: { id: 'yuqing', title: '毓庆宫', category: 'INNER', actions: ['储君培养', '监国', '封爵', '问责', '皇子婚配'], peopleKinds: ['PRINCE'], status: 'PARTIAL' },
};
